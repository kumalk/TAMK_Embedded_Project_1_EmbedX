   ...
   if(pos_s > -1){   //To staight drive forward or backward 
      ...
      if(pos_s >-1){
        ...
        if(sometexthere.toInt()>0){
          goPlan[2]='f';
          goPlan[1] = abs(sometexthere.toInt());
          goPlan[3]=0;
        }else{
          goPlan[1] = abs(sometexthere.toInt());
          goPlan[2]='b';
        ...
        if(pos_r > -1){   //Turn by spesific angle
          ...
          pos_r = message.indexOf(":");
            if(pos_r >-1){
              ...
              goPlan[3] = abs(sometexthere.toInt());
              goPlan[1] = 0;
              goFlag = true;
        ...
        if(pos_sp > -1){ // Set new default speed as percerntage 
          ...
          pos_r = message.indexOf(":");
            if(pos_r >-1){
              String sometexthere = message.substring(pos_r+1);
              goPlan[0] = abs(sometexthere.toInt());
              goPlan[1]=0;
              goFlag = true;
            }
        }
        ...
        if(pos_n > -1){ // Turn to north
          ...
          Serial.println("Command = ToNorth");
              ...
              char rotationDir;
              goPlan[3] = getRotationAngle(NorthDir, rotationDir);
              goPlan[4] = rotationDir; 
              goPlan[1]=0;
              goFlag = true;
        }
        ...
        if(pos_dir>-1){ //turn to a spesific riection
          ...
          pos_dir = message.indexOf(":");
            if(pos_dir>-1){
              ...
              char rotationDir;
              goPlan[3] = getRotationAngle(turnToDir, rotationDir);
              goPlan[4] = rotationDir; 
              goPlan[1]=0;
              goFlag = true;
